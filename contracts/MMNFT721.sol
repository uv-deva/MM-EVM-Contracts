    ...
    Role
{
    ...
    function safeMint(address to, string memory uri, address creator, uint256 value) public returns (uint256) {
    ...
    function supportsInterface(
        bytes4 interfaceId
    ) public view override(ERC721, ERC721Enumerable, AccessControl, Royalties, ERC721URIStorage) returns (bool) {
        return
